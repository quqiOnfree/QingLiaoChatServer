...
public:
  ...
  [[nodiscard]] static bool emailMatch(string_param email) {
  ...
  [[nodiscard]] static bool ipAddressMatch(string_param ip_address) {
  ...
  [[nodiscard]] static bool phoneMatch(string_param phone) {
